...
def deploy(path=None, user=None, url_prefix='', remote_proxy=None,
    ...
    Parameters:
      path: base deploy directory on remote host; deploy expects a
            ...
            Default: env.remote_path = /home/httpd/sites/repose
    ...
    Example usage:
      fab deploy:/home/repose/,repos -H servername
      fab deploy:user=www-data,url_prefix=/rps -H servername
